...
vsim -coverage -t 1ns -GLOG_RELATIVE_MARGIN=0 -GTESTCASE=0 -GERRNO=4 work.morse_char_receiver_tb
...
run -all
coverage attribute -name TESTNAME -value testerrno4
coverage save ../testerrno4.ucdb
