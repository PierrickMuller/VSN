...
vsim -coverage -t 1ns -GLOG_RELATIVE_MARGIN=0 -GTESTCASE=0 -GERRNO=8 work.morse_char_receiver_tb
...
run -all
coverage attribute -name TESTNAME -value testerrno8
coverage save ../testerrno8.ucdb
