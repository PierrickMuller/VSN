...
vsim -coverage -t 1ns -GLOG_RELATIVE_MARGIN=0 -GTESTCASE=0 -GERRNO=0 work.morse_char_receiver_tb
...
run -all
coverage attribute -name TESTNAME -value testerrno0
coverage save ../testerrno0.ucdb
