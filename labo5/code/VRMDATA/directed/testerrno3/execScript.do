...
vsim -coverage -t 1ns -GLOG_RELATIVE_MARGIN=0 -GTESTCASE=0 -GERRNO=3 work.morse_char_receiver_tb
...
run -all
coverage attribute -name TESTNAME -value testerrno3
coverage save ../testerrno3.ucdb
