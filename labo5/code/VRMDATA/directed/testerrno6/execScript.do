...
vsim -coverage -t 1ns -GLOG_RELATIVE_MARGIN=0 -GTESTCASE=0 -GERRNO=6 work.morse_char_receiver_tb
...
run -all
coverage attribute -name TESTNAME -value testerrno6
coverage save ../testerrno6.ucdb
