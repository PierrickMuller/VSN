...
vsim -coverage -t 1ns -GLOG_RELATIVE_MARGIN=0 -GTESTCASE=3 -GERRNO=0 work.morse_char_receiver_tb
...
run -all
coverage attribute -name TESTNAME -value testcase_valid_ascii
coverage save ../testcase_valid_ascii.ucdb
