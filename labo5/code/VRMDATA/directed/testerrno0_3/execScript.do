...
vsim -coverage -t 1ns -GLOG_RELATIVE_MARGIN=3 -GTESTCASE=0 -GERRNO=0 work.morse_char_receiver_tb
...
run -all
coverage attribute -name TESTNAME -value testerrno0_3
coverage save ../testerrno0_3.ucdb
