...
vsim -coverage -t 1ns -GLOG_RELATIVE_MARGIN=0 -GTESTCASE=0 -GERRNO=1 work.morse_char_receiver_tb
...
run -all
coverage attribute -name TESTNAME -value testerrno1
coverage save ../testerrno1.ucdb
