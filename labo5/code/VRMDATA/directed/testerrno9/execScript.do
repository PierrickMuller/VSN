...
vsim -coverage -t 1ns -GLOG_RELATIVE_MARGIN=0 -GTESTCASE=0 -GERRNO=9 work.morse_char_receiver_tb
...
run -all
coverage attribute -name TESTNAME -value testerrno9
coverage save ../testerrno9.ucdb
