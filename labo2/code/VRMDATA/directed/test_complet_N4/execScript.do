...
vsim -coverage -t 10ps -GN=4 -GTESTCASE=1 -GERRNO=0 project_lib.com_store_velux_tb
...
run -all
coverage attribute -name TESTNAME -value test_complet_N4
coverage save ../test_complet_N4.ucdb
