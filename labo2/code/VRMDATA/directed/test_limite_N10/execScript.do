...
vsim -coverage -t 10ps -GN=10 -GTESTCASE=3 -GERRNO=0 project_lib.com_store_velux_tb
...
run -all
coverage attribute -name TESTNAME -value test_limite_N10
coverage save ../test_limite_N10.ucdb
