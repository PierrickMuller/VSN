...
vsim -coverage -t 10ps -GN=20 -GTESTCASE=2 -GERRNO=0 project_lib.com_store_velux_tb
...
run -all
coverage attribute -name TESTNAME -value test_aleatoire_N20
coverage save ../test_aleatoire_N20.ucdb
