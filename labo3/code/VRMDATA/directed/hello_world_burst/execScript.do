...
vsim -coverage -t 10ps -GFIFOSIZE=8 -GTESTCASE=4 -GERRNO=0 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value hello_world_burst
coverage save ../hello_world_burst.ucdb
