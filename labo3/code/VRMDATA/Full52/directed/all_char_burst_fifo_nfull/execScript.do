...
vsim -coverage -t 10ps -GFIFOSIZE=8 -GTESTCASE=8 -GERRNO=0 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value all_char_burst_fifo_nfull
coverage save ../all_char_burst_fifo_nfull.ucdb
