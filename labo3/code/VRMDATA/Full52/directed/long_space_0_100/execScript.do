...
vsim -coverage -t 10ps -GFIFOSIZE=8 -GTESTCASE=12 -GERRNO=0 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value long_space_0_100
coverage save ../long_space_0_100.ucdb
