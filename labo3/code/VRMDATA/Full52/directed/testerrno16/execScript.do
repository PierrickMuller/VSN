...
vsim -coverage -t 10ps -GFIFOSIZE=52 -GTESTCASE=0 -GERRNO=16 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value testerrno16
coverage save ../testerrno16.ucdb
