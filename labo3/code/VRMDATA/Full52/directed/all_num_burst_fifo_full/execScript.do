...
vsim -coverage -t 10ps -GFIFOSIZE=10 -GTESTCASE=6 -GERRNO=0 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value all_num_burst_fifo_full
coverage save ../all_num_burst_fifo_full.ucdb
