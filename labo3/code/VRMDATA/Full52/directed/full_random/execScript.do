...
vsim -coverage -t 10ps -GFIFOSIZE=8 -GTESTCASE=15 -GERRNO=0 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value full_random
coverage save ../full_random.ucdb
