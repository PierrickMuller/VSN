...
vsim -coverage -t 10ps -GFIFOSIZE=8 -GTESTCASE=7 -GERRNO=0 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value hello_world_burst_fifo_nfull
coverage save ../hello_world_burst_fifo_nfull.ucdb
