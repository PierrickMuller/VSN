...
vsim -coverage -t 10ps -GFIFOSIZE=52 -GTESTCASE=0 -GERRNO=15 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value testerrno15
coverage save ../testerrno15.ucdb
