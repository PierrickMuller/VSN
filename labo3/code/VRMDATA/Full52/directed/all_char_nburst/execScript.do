...
vsim -coverage -t 10ps -GFIFOSIZE=8 -GTESTCASE=2 -GERRNO=0 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value all_char_nburst
coverage save ../all_char_nburst.ucdb
