...
vsim -coverage -t 10ps -GFIFOSIZE=52 -GTESTCASE=0 -GERRNO=12 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value testerrno12
coverage save ../testerrno12.ucdb
