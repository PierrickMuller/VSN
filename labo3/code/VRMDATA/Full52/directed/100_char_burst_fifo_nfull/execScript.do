...
vsim -coverage -t 10ps -GFIFOSIZE=8 -GTESTCASE=10 -GERRNO=0 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value 100_char_burst_fifo_nfull
coverage save ../100_char_burst_fifo_nfull.ucdb
