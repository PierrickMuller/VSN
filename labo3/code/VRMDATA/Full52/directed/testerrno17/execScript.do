...
vsim -coverage -t 10ps -GFIFOSIZE=52 -GTESTCASE=0 -GERRNO=17 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value testerrno17
coverage save ../testerrno17.ucdb
