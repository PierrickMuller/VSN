...
vsim -coverage -t 10ps -GFIFOSIZE=52 -GTESTCASE=0 -GERRNO=13 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value testerrno13
coverage save ../testerrno13.ucdb
