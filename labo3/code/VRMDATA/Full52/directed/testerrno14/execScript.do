...
vsim -coverage -t 10ps -GFIFOSIZE=52 -GTESTCASE=0 -GERRNO=14 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value testerrno14
coverage save ../testerrno14.ucdb
