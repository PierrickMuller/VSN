...
vsim -coverage -t 10ps -GFIFOSIZE=52 -GTESTCASE=5 -GERRNO=0 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value all_char_burst_fifo_full
coverage save ../all_char_burst_fifo_full.ucdb
