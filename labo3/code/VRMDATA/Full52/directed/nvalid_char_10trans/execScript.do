...
vsim -coverage -t 10ps -GFIFOSIZE=8 -GTESTCASE=11 -GERRNO=0 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value nvalid_char_10trans
coverage save ../nvalid_char_10trans.ucdb
