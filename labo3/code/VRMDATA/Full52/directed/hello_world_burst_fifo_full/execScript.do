...
vsim -coverage -t 10ps -GFIFOSIZE=11 -GTESTCASE=4 -GERRNO=0 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value hello_world_burst_fifo_full
coverage save ../hello_world_burst_fifo_full.ucdb
