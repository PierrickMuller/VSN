...
vsim -coverage -t 10ps -GFIFOSIZE=8 -GTESTCASE=14 -GERRNO=0 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value word_size_0_100
coverage save ../word_size_0_100.ucdb
