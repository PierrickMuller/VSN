...
vsim -coverage -t 10ps -GFIFOSIZE=8 -GTESTCASE=13 -GERRNO=0 work.morse_burst_emitter_tb
...
run -all
coverage attribute -name TESTNAME -value change_dot_period
coverage save ../change_dot_period.ucdb
